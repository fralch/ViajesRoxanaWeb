        ...
        <div className="min-h-screen bg-gradient-to-br from-red-50 to-orange-50 flex items-center justify-center px-4 py-8">
            <div className="w-full max-w-md">
                ...
                <div className="text-center mb-8">
                    <h1 className="text-2xl font-bold text-red-600 mb-2">¡Únete a nuestras aventuras!</h1>
                </div>
                ...
                <div className="bg-white rounded-2xl shadow-xl border border-gray-100 overflow-hidden">
                    <div className="px-8 py-10">
                        <form onSubmit={submit}>
                            ...
                            <div className="text-center text-2xl font-semibold text-gray-800 mb-8">Crear Cuenta</div>
                            ...
                            <div className="border-t border-gray-200 pt-4">
                                <div className="text-center">
                                    <p className="text-sm text-gray-600">
                                        ...
                                        <a href={route('login')} className="text-red-600 hover:text-red-700 font-medium hover:underline transition-colors duration-200">
                                            Inicia sesión
                                        </a>
                                    </p>
                                </div>
