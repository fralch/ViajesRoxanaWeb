          ...
          <div className="overflow-hidden bg-white shadow-lg sm:rounded-xl border border-gray-100">
            <div className="p-8">
              ...
              <form onSubmit={handleSubmit} className="space-y-6">
                ...
                {/* Selección de tipos de encargados */}
                <div className="space-y-4">
                  <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                    {/* Encargados Internos */}
                    <div className="relative flex items-center p-4 bg-red-50 rounded-lg border-2 border-red-300">
                      <div className="ml-3">
                        <div className="flex items-center gap-2">
                          <svg className="w-4 h-4 text-red-600" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                            <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M19 21V5a2 2 0 00-2-2H7a2 2 0 00-2 2v16m14 0h2m-2 0h-5m-9 0H3m2 0h5M9 7h1m-1 4h1m4-4h1m-1 4h1m-5 10v-5a1 1 0 011-1h2a1 1 0 011 1v5m-4 0h4" />
                          </svg>
                          <span className="text-sm font-medium text-gray-900">Encargados Externo</span>
                        </div>
                        <p className="text-xs text-gray-500 mt-1">Personal del colegio</p>
                      </div>
                    </div>

                    {/* Encargados de Agencia */}
                    <div className="relative flex items-center p-4 bg-amber-50 rounded-lg border-2 border-amber-300">
                      <div className="ml-3">
                        <div className="flex items-center gap-2">
                    ...
                    <div className="space-y-4">
                      {encargadosAgencia.map((encargado, index) => (
                        <div key={index} className="grid grid-cols-1 md:grid-cols-3 gap-4 p-4 bg-white rounded-lg border border-gray-200 relative">
                          ...
                          <div>
                            <InputLabel htmlFor={`nombre_encargado_agencia_${index}`} value="Nombre del Encargado" />
                            <TextInput
                          ...
                          <div>
                            <InputLabel htmlFor={`celular_encargado_agencia_${index}`} value="Celular del Encargado" />
                            <div className="flex gap-2">
                              <TextInput
