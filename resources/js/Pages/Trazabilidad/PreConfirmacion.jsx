        ...
        <div className="max-w-md w-full">
          ...
          <div className="bg-white rounded-2xl shadow-2xl border border-gray-100 overflow-hidden">
            ...
            <div className="p-6 space-y-6">
              ...
              {/* Botón para ver fichas médicas - Solo mostrar si el hijo tiene permiso */}
              {hijo?.ver_fichas && (
                <div className="pt-2">
                  <button 
                    onClick={() => router.get(`/nfc/${hijo?.doc_numero}/fichas`)}
                    className="w-full bg-gradient-to-r from-blue-500 to-blue-600 text-white py-3 px-6 rounded-xl font-semibold text-base shadow-lg hover:shadow-xl transition-all duration-200 flex items-center justify-center hover:from-blue-600 hover:to-blue-700"
                  >
                    <svg className="w-5 h-5 mr-3" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                      <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M9 12h6m-6 4h6m2 5H7a2 2 0 01-2-2V5a2 2 0 012-2h5.586a1 1 0 01.707.293l5.414 5.414a1 1 0 01.293.707V19a2 2 0 01-2 2z"/>
                    </svg>
                    Ver Fichas de Salud y Nutrición
                  </button>
                </div>
              )}
